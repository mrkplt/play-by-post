...
# pkg:gem/orm_adapter#lib/orm_adapter/adapters/active_record.rb:4
class OrmAdapter::ActiveRecord < ::OrmAdapter::Base
  # Return list of column/property names
  #
  # pkg:gem/orm_adapter#lib/orm_adapter/adapters/active_record.rb:6
  def column_names; end

  # @see OrmAdapter::Base#create!
  #
  # pkg:gem/orm_adapter#lib/orm_adapter/adapters/active_record.rb:31
  def create!(attributes = T.unsafe(nil)); end

  # @see OrmAdapter::Base#destroy
  #
  # pkg:gem/orm_adapter#lib/orm_adapter/adapters/active_record.rb:36
  def destroy(object); end

  # @see OrmAdapter::Base#find_all
  #
  # pkg:gem/orm_adapter#lib/orm_adapter/adapters/active_record.rb:26
  def find_all(options = T.unsafe(nil)); end

  # @see OrmAdapter::Base#find_first
  #
  # pkg:gem/orm_adapter#lib/orm_adapter/adapters/active_record.rb:21
  def find_first(options = T.unsafe(nil)); end

  # @see OrmAdapter::Base#get
  #
  # pkg:gem/orm_adapter#lib/orm_adapter/adapters/active_record.rb:16
  def get(id); end

  # @see OrmAdapter::Base#get!
  #
  # pkg:gem/orm_adapter#lib/orm_adapter/adapters/active_record.rb:11
  def get!(id); end
  ...
  #
  # pkg:gem/orm_adapter#lib/orm_adapter/adapters/active_record.rb:53
  def conditions_to_fields(conditions); end

  # pkg:gem/orm_adapter#lib/orm_adapter/adapters/active_record.rb:41
  def construct_relation(relation, options); end

  # pkg:gem/orm_adapter#lib/orm_adapter/adapters/active_record.rb:73
