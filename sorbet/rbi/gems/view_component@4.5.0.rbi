...
class ViewComponent::Base
  ...
  #
  # pkg:gem/view_component#lib/view_component/base.rb:94
  def initialize; end
  ...
  # @private
  #
  # pkg:gem/view_component#lib/view_component/base.rb:353
  ...
  # @return [void]
  #
  # pkg:gem/view_component#lib/view_component/base.rb:235
  ...
  # @return [void]
  #
  # pkg:gem/view_component#lib/view_component/base.rb:227
  ...
  # @return [String]
  #
  # pkg:gem/view_component#lib/view_component/base.rb:361
  def content; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/view_component#lib/view_component/base.rb:378
  def content?; end
  ...
  #
  # pkg:gem/view_component#lib/view_component/base.rb:284
  def controller; end
  ...
  #
  # pkg:gem/view_component#lib/view_component/base.rb:294
  def helpers; end
  ...
  # @private
  #
  # pkg:gem/view_component#lib/view_component/base.rb:309
  ...
  # @return [String]
  #
  # pkg:gem/view_component#lib/view_component/base.rb:219
  ...
  # @return [String]
  #
  # pkg:gem/view_component#lib/view_component/base.rb:212
  ...
  # @private
  #
  # pkg:gem/view_component#lib/view_component/base.rb:254
  ...
  # @return [Boolean]
  #
  # pkg:gem/view_component#lib/view_component/base.rb:242
  def render?; end
  ...
  # @return [String]
  #
  # pkg:gem/view_component#lib/view_component/base.rb:105
  ...
  # double-rendering.
  #
  # pkg:gem/view_component#lib/view_component/base.rb:181
  ...
  #
  # pkg:gem/view_component#lib/view_component/base.rb:196
  ...
  #
  # pkg:gem/view_component#lib/view_component/base.rb:348
  def request; end
  ...
  # @return [void]
  #
  # pkg:gem/view_component#lib/view_component/base.rb:86
  ...
  # @private
  #
  # pkg:gem/view_component#lib/view_component/base.rb:332
  ...
  # @private
  #
  # pkg:gem/view_component#lib/view_component/base.rb:326
  ...
  # @private
  #
  # pkg:gem/view_component#lib/view_component/base.rb:385
  ...
  # @return [Boolean]
  #
  # pkg:gem/view_component#lib/view_component/base.rb:401
  def __vc_content_set_by_with_content_defined?; end

  # pkg:gem/view_component#lib/view_component/base.rb:405
  def __vc_maybe_escape_html(text); end

  # @return [Boolean]
  #
  # pkg:gem/view_component#lib/view_component/base.rb:397
  ...
  # pkg:gem/view_component#lib/view_component/base.rb:417
  def __vc_safe_output_preamble; end

  # Returns the value of attribute view_context.
  #
  # pkg:gem/view_component#lib/view_component/base.rb:395
  def view_context; end

  class << self
    # @private
    #
    # pkg:gem/view_component#lib/view_component/base.rb:702
    def __vc_collection_counter_parameter; end

    # @private
    #
    # pkg:gem/view_component#lib/view_component/base.rb:712
    def __vc_collection_iteration_parameter; end

    # @private
    #
    # pkg:gem/view_component#lib/view_component/base.rb:697
    def __vc_collection_parameter; end

    # @private
    #
    # pkg:gem/view_component#lib/view_component/base.rb:567
    def __vc_compile(raise_errors: T.unsafe(nil), force: T.unsafe(nil)); end

    # @private
    # @return [Boolean]
    #
    # pkg:gem/view_component#lib/view_component/base.rb:615
    def __vc_compiled?; end

    # @private
    #
    # pkg:gem/view_component#lib/view_component/base.rb:635
    def __vc_compiler; end

    # @private
    # @return [Boolean]
    #
    # pkg:gem/view_component#lib/view_component/base.rb:707
    def __vc_counter_argument_present?; end

    # @private
    #
    # pkg:gem/view_component#lib/view_component/base.rb:630
    ...
    #
    # pkg:gem/view_component#lib/view_component/base.rb:677
    ...
    #
    # pkg:gem/view_component#lib/view_component/base.rb:690
    ...
    #
    # pkg:gem/view_component#lib/view_component/base.rb:625
    ...
    # @return [String]
    #
    # pkg:gem/view_component#lib/view_component/base.rb:503
    def identifier; end

    # @private
    #
    # pkg:gem/view_component#lib/view_component/base.rb:506
    def identifier=(_arg0); end

    # @private
    # @private
    #
    # pkg:gem/view_component#lib/view_component/base.rb:572
    ...
    #
    # pkg:gem/view_component#lib/view_component/base.rb:518
    ...
    #
    # pkg:gem/view_component#lib/view_component/base.rb:660
    ...
    # @return [Boolean]
    #
    # pkg:gem/view_component#lib/view_component/base.rb:667
    def strip_trailing_whitespace?; end

    # @private
    #
    # pkg:gem/view_component#lib/view_component/base.rb:509
    def virtual_path; end
    ...
    #
    # pkg:gem/view_component#lib/view_component/base.rb:562
    ...
    #
    # pkg:gem/view_component#lib/view_component/base.rb:646
    ...
    # pkg:gem/view_component#lib/view_component/base.rb:727
    ...
    # pkg:gem/view_component#lib/view_component/base.rb:740
    def __vc_provided_collection_parameter; end

    # @return [Boolean]
    #
    # pkg:gem/view_component#lib/view_component/base.rb:723
...
class ViewComponent::Config
  ...
  #
  # pkg:gem/view_component#lib/view_component/config.rb:181
  def initialize; end
  ...
  #
  # pkg:gem/view_component#lib/view_component/config.rb:179
  def current; end
  ...
  class << self
    ...
    # pkg:gem/view_component#lib/view_component/config.rb:155
    ...
    # @return [Boolean]
    #
    # pkg:gem/view_component#lib/view_component/config.rb:131
    def default_preview_paths; end

    # pkg:gem/view_component#lib/view_component/config.rb:162
    def default_previews_options; end

    # pkg:gem/view_component#lib/view_component/config.rb:141
    def default_rails_engines_preview_paths; end

    # pkg:gem/view_component#lib/view_component/config.rb:135
    def default_rails_preview_paths; end

    # pkg:gem/view_component#lib/view_component/config.rb:13
    def defaults; end

    # pkg:gem/view_component#lib/view_component/config.rb:149
...
class ViewComponent::Preview
  ...
  class << self
    # @private
    #
    # pkg:gem/view_component#lib/view_component/preview.rb:96
    ...
    #
    # pkg:gem/view_component#lib/view_component/preview.rb:53
    def examples; end
    ...
    # @return [Boolean]
    #
    # pkg:gem/view_component#lib/view_component/preview.rb:58
    def exists?(preview); end

    # Find a component preview by its underscored class name.
    #
    # pkg:gem/view_component#lib/view_component/preview.rb:63
    def find(preview); end

    # Setter for layout name.
    #
    # pkg:gem/view_component#lib/view_component/preview.rb:74
    ...
    #
    # pkg:gem/view_component#lib/view_component/preview.rb:80
    def preview_example_template_path(example); end

    # Returns the underscored name of the component preview without the suffix.
    #
    # pkg:gem/view_component#lib/view_component/preview.rb:68
    ...
    # pkg:gem/view_component#lib/view_component/preview.rb:104
...
class ViewComponent::Slot
  ...
  # @return [Boolean]
  #
  # pkg:gem/view_component#lib/view_component/slot.rb:104
  def html_safe?; end
  ...
  # end
  #
  # pkg:gem/view_component#lib/view_component/slot.rb:100
  ...
  # @return [Boolean]
  #
  # pkg:gem/view_component#lib/view_component/slot.rb:114
  def __vc_component_instance?; end

  # @return [Boolean]
  #
  # pkg:gem/view_component#lib/view_component/slot.rb:108
...
module ViewComponent::Slotable
  ...
  # pkg:gem/view_component#lib/view_component/slotable.rb:444
...
class ViewComponent::Template
  ...
  # pkg:gem/view_component#lib/view_component/template.rb:175
  def call_method_name; end

  # pkg:gem/view_component#lib/view_component/template.rb:139
  def compile_to_component; end

  # @return [Boolean]
  #
  # pkg:gem/view_component#lib/view_component/template.rb:153
  def coverage_running?; end

  # @return [Boolean]
  #
  # pkg:gem/view_component#lib/view_component/template.rb:170
  ...
  # @return [Boolean]
  #
  # pkg:gem/view_component#lib/view_component/template.rb:166
  def inline_call?; end

  # pkg:gem/view_component#lib/view_component/template.rb:185
...
class ViewComponent::Template::File < ::ViewComponent::Template
  ...
  #
  # pkg:gem/view_component#lib/view_component/template.rb:58
  def source; end
  ...
  # pkg:gem/view_component#lib/view_component/template.rb:64
  def compiled_source; end
end

# pkg:gem/view_component#lib/view_component/template.rb:73
class ViewComponent::Template::Inline < ::ViewComponent::Template
  # @return [Inline] a new instance of Inline
  #
  # pkg:gem/view_component#lib/view_component/template.rb:76
  def initialize(component:, inline_template:); end

  # Returns the value of attribute source.
  #
  # pkg:gem/view_component#lib/view_component/template.rb:74
  def source; end

  # pkg:gem/view_component#lib/view_component/template.rb:100
  def type; end
end

# pkg:gem/view_component#lib/view_component/template.rb:105
class ViewComponent::Template::InlineCall < ::ViewComponent::Template
  ...
  # pkg:gem/view_component#lib/view_component/template.rb:120
  def compile_to_component; end

  # @return [Boolean]
  #
  # pkg:gem/view_component#lib/view_component/template.rb:134
  def defined_on_self?; end

  # pkg:gem/view_component#lib/view_component/template.rb:124
  def safe_method_name_call; end

  # pkg:gem/view_component#lib/view_component/template.rb:116
  def type; end
end
