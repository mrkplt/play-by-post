...
class Post
  ...
  module GeneratedAttributeMethods
    ...
    sig { params(value: T::Boolean).returns(T::Boolean) }
    def is_ooc=(value); end

    sig { returns(T::Boolean) }
    def is_ooc?; end

    sig { returns(T.nilable(T::Boolean)) }
    def is_ooc_before_last_save; end

    sig { returns(T.untyped) }
    def is_ooc_before_type_cast; end

    sig { returns(T::Boolean) }
    def is_ooc_came_from_user?; end

    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def is_ooc_change; end

    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def is_ooc_change_to_be_saved; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def is_ooc_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(T::Boolean)) }
    def is_ooc_in_database; end

    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def is_ooc_previous_change; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def is_ooc_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(T::Boolean)) }
    def is_ooc_previously_was; end

    sig { returns(T.nilable(T::Boolean)) }
    def is_ooc_was; end

    sig { void }
    def is_ooc_will_change!; end
    ...
    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def saved_change_to_is_ooc; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_is_ooc?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_is_ooc?(from: T.unsafe(nil), to: T.unsafe(nil)); end
