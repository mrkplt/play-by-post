...
ActiveRecord::Schema[8.1].define(version: 2026_09_02_000200) do
  ...
  create_table "notebook_entries", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["game_id"], name: "index_notebook_entries_on_game_id"
    t.index ["promoted_page_id"], name: "index_notebook_entries_on_promoted_page_id"
  ...
  create_table "page_versions", force: :cascade do |t|
    ...
    t.string "title"
    t.datetime "updated_at", null: false
    t.index ["edited_by_id"], name: "index_page_versions_on_edited_by_id"
  ...
  create_table "scene_summary_versions", force: :cascade do |t|
    t.text "body"
    t.datetime "created_at", null: false
    t.integer "edited_by_id", null: false
    t.datetime "generated_at"
    t.integer "scene_summary_id", null: false
    t.datetime "updated_at", null: false
    t.index ["edited_by_id"], name: "index_scene_summary_versions_on_edited_by_id"
    t.index ["scene_summary_id"], name: "index_scene_summary_versions_on_scene_summary_id"
  end
  ...
  add_foreign_key "page_versions", "users", column: "edited_by_id"
  ...
  add_foreign_key "scene_summary_versions", "scene_summaries"
  add_foreign_key "scene_summary_versions", "users", column: "edited_by_id"
